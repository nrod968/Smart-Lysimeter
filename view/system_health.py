...
class SmartLysimeterSystemHealth(SmartLysimeterWindow):
    def __init__(self, root: Tk):
        ...
        self._phLbl = Label(root, textvariable=self._phTxt, bg="#FFF2CC", fg='green', font=("RobotoRoman Regular", 18 * -1))
        self._ecLbl = Label(root, textvariable=self._ecTxt, bg="#FFF2CC", fg='green', font=("RobotoRoman Regular", 18 * -1))
        self._tankLbl = Label(root, textvariable=self._tankTxt, bg="#FFF2CC", fg='green', font=("RobotoRoman Regular", 18 * -1))
        self._phDrainageLbl = Label(root, textvariable=self._phDrainageTxt, bg="#FFF2CC", fg='green', font=("RobotoRoman Regular", 18 * -1))
        self._ecDrainageLbl = Label(root, textvariable=self._ecDrainageTxt, bg="#FFF2CC", fg='green', font=("RobotoRoman Regular", 18 * -1))
        self._drainageLbl = Label(root, textvariable=self._drainageTxt, bg="#FFF2CC", fg='green', font=("RobotoRoman Regular", 18 * -1))
